...
export function Hero() {
    return (
        <section className="flex flex-col lg:flex-row items-center justify-center text-center gap-4 h-[80vh] px-4">
         ...
         <div className='flex flex-col gap-4 flex-wrap pr-20 '>
            <button className='w-[60%] cursor-pointer hover:rounded-[5px] transition-all py-1 m-auto font-semibold bg-principal'>Technologies</button>
            <button className='w-[60%] cursor-pointer hover:rounded-[5px] transition-all py-1 m-auto font-semibold bg-principal'>Projects</button>
            <button className='w-[60%] cursor-pointer hover:rounded-[5px] transition-all py-1 m-auto font-semibold bg-principal'>Skills</button>
            <button className='w-[60%] cursor-pointer hover:rounded-[5px] transition-all py-1 m-auto font-semibold bg-principal'>About Me</button>
